...
class Keyboard:
    ...
    def __init__(self):
        ...
        self.volume_pin = Pin("B0", Pin.IN)
        self.instr_pin = Pin("C4", Pin.IN)
        self.loop_pin = Pin("A7", Pin.IN)
        self.drum_pin = Pin("A6", Pin.IN)
