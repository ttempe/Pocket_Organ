...
class Metronome:
    def __init__(self, midi):
        ...
        self.enable = False
        self.user_wants = False
        self.paused = False
        self.last_beat = ticks_ms()     #in ms
    ...
    def on(self, user=False):
        self.enable = True
        if user:
            self.user_wants = True
    ...
    def pause(self):
        self.paused = True
        self.pause_time = ticks_ms()-self.last_beat
    
    def resume(self):
        if self.paused:
            self.last_beat = ticks_ms()-self.pause_time
            self.paused = False
        
    def toggle(self):
        self.enable = not(self.enable)
        self.user_wants = self.enable
